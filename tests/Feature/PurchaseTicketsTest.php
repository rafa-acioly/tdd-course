...
class PurchaseTicketsTest extends TestCase
{
    ...
    {
        $this->json('POST', "/concert/{$concert->id}/orders", $params);
    }
    ...
    /** @test */
    public function customer_can_purchase_ticket_to_a_published_concert()
    {
    ...
    /** @test */
    public function cannot_purchase_tickets_to_anpublished_concert()
    {
